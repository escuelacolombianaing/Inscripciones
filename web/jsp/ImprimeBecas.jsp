...
-->
    ...
    <body>  
        ...
        <table width="98%" border="0" align="center" class="textoimpre">
           ...
           // out.println(lon);
            if (lon <= 0){
            out.println("La información  no concuerda con la diligenciada, o usted no está inscrito a la convocatoria de Becas,  por favor verifique los datos.");
            } else {
            ...
            <table width="660" align="center" border="0" cellpadding="1" cellspacing="0" class="textoimpre">
                ...
                <tr> 
                 ...
                 <tr>
                    <td width="31%"><b>Interés Académico:</b> &nbsp;&nbsp;</td>
          ...
          <tr> 
            ...
            <td colspan="2"><!%=estudiante.elementAt(50)%></td>
             ...
             <tr>
                ...
                %>
                <tr> 
                    <td width="31%"><b>Padre egresado de la Escuela Col. de Ingeniería:</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=egresa%></td>
