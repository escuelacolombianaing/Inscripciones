<%-- 
    Document   : Posgrados
    Created on : 22/08/2016, 02:31:16 PM
    Author     : Lucero
--%>
                    ...
                    <table width="750" border="0" align="left" cellpadding="0" cellspacing="0">
                        <tr>
                            <td> <fieldset><legend class="textocom"><strong>Solicitud de n&uacute;mero
                                        ...
                                        <form action="ReferenciaPosgrado" method="post" onSubmit="return comprueba( );" name="form1" id="form1">

                                            <table width="750" class="textocom" border="0">
                                                <tr bgcolor="#F3F3F3"> 
                                                    <td height="25"> 
                                                    ...
                                                    <td height="25"> 
                                                        <select name="idplan" class="dato" size="1">
                                                            ...
                                                            <!--option value="370">Especializaci&oacute;n en Gestión Integrada QHSE</option-->
                                                            <option value="370">Especialización en Gestión Integrada en Seguridad, Salud en el Trabajo, Calidad y Medio Ambiente</option>
