<%-- 
    Document   : indexposcontxt
    Created on : 12/07/2010, 09:14:39 AM
    Author     : lrodriguez
--%>
...
<%
        ...
        String idplan = request.getParameter("tipprog");
     ...
     /*   String fechaActual = formatter.format(hoy);
       ...
       if (prog.equals(tipoest)) {
            if (((hoy.after(inicio) && hoy.before(finall)) || fechaActual.equals(Y)) && (posgrados.elementAt(5).equals("1"))) {
                ban = 1;
            }
        }*/
%>
...
<html>
 ...
 <%if (ban == 1) {%>
   ...
   <%} else {%>
           ...
           alert("Las inscripciones de Economía para Ingenieros y Gestión Integrada QHSE se habilitarán nuevamente a partir del 13 de Abril de 2009");
   <%}%>
       }
       function textoin(id){
            ...
            <tr>
                <td>
                    ...
                    <table width="90%" border="0" cellspacing="0" cellpadding="0" class="textocom">
                        ...
                        <tr bgcolor="#336699">
                            <td colspan="2" bgcolor="#336699" class="bodystyle"  onMouseOver="textoin('f6'); ilum(this,'#ACC8E3')" onMouseOut="textout('f6'); ilum(this,'#336699')"><a href="javascript:ventanaSecundaria('ReferenciaPosgrado')" onMouseOut="window.status='  '"
                                                                                                                                                                                           onMouseOver="window.status='http://www.escuelaing.edu.co';return true"><font color="#FFFFFF" id="f6"><b>2.
                                            Una vez haya leído las instrucciones, regístrese aquí
                            y solicite su número de referencia de pago </b></font></a></td>
                        </tr>
                        <tr valign="top">
                        ...
                        <tr>
                            <td colspan="2"><strong>&#8226;Si ya solicit&oacute; su n&uacute;mero
                                ...
                                hacerlo aqui: <a href="http://tycho.escuelaing.edu.co/PagosenLinea/loginAdmitido?id=1"><strong><font color="#336699">&lt;&lt;PAGOS
                        ...
                        <tr bgcolor="#336699">
                            <td colspan="2" bgcolor="#336699" class="bodystyle"  onMouseOver="textoin('f7'); ilum(this,'#ACC8E3')" onMouseOut="textout('f7'); ilum(this,'#336699')"><a href="javascript:ventanaSecundaria('SolicitudPosgrado')" onMouseOut="window.status='  '"
                            ...
                            <td colspan="2"><font face="Arial, Helvetica, sans-serif" size="2">
                                    <p align="justify">Tenga en cuenta que no podr&aacute; diligenciar
                                        ...
                                        el pago. Si desea verificar el envio de su solicitud de admisi&oacute;n<font color="#336699">
                                            <a href="javascript:ventanaSecundaria('SolicitudPosgrado')" onMouseOut="window.status='  '"
                                               onMouseOver="window.status='http://www.escuelaing.edu.co';return true"><font color="#0000FF">haga
                                        click aqu&iacute;</font></a>.</font><font color="#336699"> Si
                                        ya diligencio su solicitud de admisi&oacute;n <a href="javascript:ventanaSecundaria('SolicitudPosgrado')" onMouseOut="window.status='  '"
                    ...
                    <p ><b class="resaltados">Para cualquier informaci&oacute;n adicional comun&iacute;quese
                        al tel&eacute;fono 6683600 exts. 274, 263, 101 o al e-mail <a href="mailto:admisiones@escuelaing.edu.co"><font color="#0000FF">admisiones@escuelaing.edu.co</font></a></b>
                    </p>
                    <p>&nbsp;</p>
