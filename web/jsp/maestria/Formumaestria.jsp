<%-- 
    Document   : Formumaestria
    Created on : 3/08/2016, 10:01:41 AM
    Author     : Lucero
--%>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-8 col-md-offset-2">
                        <form  name="form1"  method="post" onSubmit="return comprueba( );" action="GrabaEstudianteMa">
                            <h3>Solicitud de Admisión a la maestría<hr></h3>
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-9">
                                    <div class="form-group">
                                        ...
                                        <select name="campo1" class="form-group">
                                            <option value="N" ><b>Seleccione</b>
                                            <option value="332" <%if (pginsc.elementAt(1).equals("332")) {
                                                    out.println("selected");
                                                }%>>MODALIDAD DE PROFUNDIZACIÓN</option>
                                            <option value="333" <%if (pginsc.elementAt(1).equals("333")) {
                                                    out.println("selected");
                                    ...
                                    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-12">
                                                    <div class="form-group">
                                                        <textarea class="form-control" maxlength="255"  name="campo64" cols="85" rows="2" wrap="VIRTUAL" onBlur="this.value = convertTildes(this.value);"></textarea>
                                                    </div>
                                                </div>
                                            </div>		                	
                                        </div>
