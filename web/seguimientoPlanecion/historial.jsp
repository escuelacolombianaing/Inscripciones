...
<body>
    ...
    <nav>
        ...
        <ul class="nav nav-pills nav-justified">
          ...
          <li role="presentation" class="active"><a href="historial.html"><span class="glyphicon glyphicon-list-alt"></span> Historial</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 filaCompleta">
                    <h3>A continuación se presentan sus <strong>proyectos por estado:</strong></h3><br>
                    <p>
