...
public class guardaDatosDoc {
    ...
    public guardaDatosDoc() {
    }
    
    public guardaDatosDoc(HttpServletRequest request) {
    ...
    public String guardaEstudianteDoc() {
        ...
        int verif = bd.getExiste(arreglo[11], confeci.getPeriodoSiguiente(), arreglo[1]);
        ...
        String idprog = confeci.getIdPrograma();
      ...
      /*  if (pilo.equals("null")) {
        ...
        if (verif < 0) {
            ...
            consulta = "insert into registro.estudiante (id_est, doc_est, nom_est, id_dpto, id_plan, sexo, tip_doc, completo, estado, per_ing, ult_ing, "
                    ...
                    + "dir_acud, tel_acud, dir_otr, tel_otr, diezpor, email_otro, ulttel, refins, ar_mat, ar_cie, ar_len, ar_soc, fec_ins, maxmatnv, tpgrp, nombres, ape1, ape2, per_ingreal, docorg, pais_nacimiento)";
            valores = "values(" + sec + ",'" + arreglo[11] + "','" + nombre.toUpperCase() + "','" + depto + "','" + arreglo[1] + "','" + arreglo[8] + "','" + arreglo[12] + "',0,'-190','" + confeci.getPeriodoSiguiente()+ "','" + confeci.getPeriodoSiguiente()+ "', 1,0,0,'','P', '"
                    ...
                    + arreglo[23].toUpperCase() + "','" + arreglo[24] + "','" + arreglo[17].toUpperCase() + "','" + arreglo[18] + "',0,'" + arreglo[20] + "','" + arreglo[21] + "'," + ref + ",'0', '0', '0', '0', getdate(), '" + arreglo[77] + "', '" + promed + "', '" + nom_est.toUpperCase() + "', '" + ape1.toUpperCase() + "', '" + ape2.toUpperCase() + "', '" + confeci.getPeriodoSiguiente()+ "', '" + arreglo[11] + "', '" + arreglo[10] + "')";
    ...
    public String creaDocumen() {
        ...
        BDadmisiones bd = new BDadmisiones();
        Vector datos = bd.ValidadocumDoc();
        int tam = datos.size();
        for (int i = 1; i <= tam; i++) {
            String consultar = "insert into registro.verifica_doc_doc values (" + idEst + ",'" + i + "','N','', '')";
