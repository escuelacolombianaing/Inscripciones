...
<html>
    ...
    <body bgcolor="#FFFFFF" text="#000000">
            ...
            <tr>
                <td>
                    <b>Su documento es incorrecto o usted no ha diligenciado la
                        solicitud de admisión. Verifique e intente nuevamente o  comuníquese al 6683600 opción 2 en el menú.
                        </b>
        ...
        <%} else {
    Vector asignaturas = bd.Niveles(estudiante.elementAt(1).toString(), oout);
    ...
    if (com5 == 'A') {
        ...
        <table width="701" border="0" cellspacing="0" cellpadding="0" height="431"  align="center"  class="textoimpremas">
            ...
            pericfes = estudiante.elementAt(5).toString().substring(2, 7);%>
                ...
                out.println("<b>Química:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + estudiante.elementAt(11) + "&nbsp;&nbsp;&nbsp;&nbsp;" + clasifica5 + "</b><br>");
                    ...
                    <table width="50%" border="0" align="left" class="textoimpremas">
                        ...
                        <!--
                    <td>
                        <select name="matem&aacute;ticas">
                            <!%if (com1 == 'A') {%>
         ...
         String niveles = String.valueOf(com1) + String.valueOf(com2) + String.valueOf(com3);
         ...
         if (niveles.equals(baseicfes)) {
            ...
            <tr>
                <td>
                    ...
                    ex&aacute;menes institucionales durante la semana de inducci&oacute;n.
                    El 11 de diciembre a partir de las 2:00 pm
                    usted deberá consultar en este mismo sitio la fecha y hora de presentación de los mismos.
                    ...
                    <p> El aspirante admitido que así lo desee podrá solicitar <b><a href="ValidaReclasifica?idprog=<%=estudiante.elementAt(1)%>&docEst=<%=docEst%>">AQUI</a></b><a href="ValidaReclasifica">
                    </a>su reclasificación a un nivel inferior o superior entre el 21 de diciembre
                    de 2009 y el 12 de enero de 2010 (previa autenticación con el nombre de
                    ...
                    <p><b>La jornada de inducción</b> inicia el 12 de enero a las 7:00a.m. Allí se le proporcionará
                    ...
                    una clave de acceso para la opción de Servicios Académicos de los estudiantes en el portal web de
                    la Escuela.
                    <p>Actualmente se est&aacute;n realizando los estudios socioecon&oacute;micos
                        ...
                        <b>el d&iacute;a Viernes 30 de Octubre en el Aula Máxima Bloque C, primer piso.

                        Para apellidos del aspirante que estén <font color="#0000FF">entre las letras A-E  </font>la
                        reunión será <font color="#0000FF">a las 7:30 a.m</font>

                        Para los apellidos que estén <font color="#0000FF">entre las letras
                        F-L</font> la reunión será  <font color="#0000FF">a las 10:00 a.m </font>
                        Para los apellidos que estén <font color="#0000FF">entre las letras
                        M-Z</font> la reunión será  <font color="#0000FF">a las 2:00 p.m </font>
...
(documentos requeridos y procedimiento a seguir).</font></i></p>-->
                        ...
                        Por todo lo anterior, los  Directivos de la Institución le invitan a una reuni&oacute;n a usted y a su acudiente
                        <b>el d&iacute;a Jueves 29 de Octubre en el Aula Máxima Bloque C, primer piso.
...
(documentos requeridos y procedimiento a seguir).</font></i></p>-->
        ...
        <p>&nbsp;</p><table width="70%" border="0" align="center" textoimpremas>
            <tr>
                ...
                <td width="39%">
                    <div align="center"><a href="InstruccionesPS"><img src="img/inshorario.gif" width="180" height="50"></a></div>
                </td>

                <td width="32%"><a href="http://www.escuelaing.edu.co/documentos/FormalizacionesPS20101.pdf"><img src="img/insformaliza.gif" width="185" height="59"></a></td>

                <td width="29%"><a href="Guias?idprog=<%=idprog%>"><img src="img/guiasexamen.gif" width="180" height="51"></a></td>
            </tr>
            <!--  <tr>
          <td width="49%">
            ...
            <tr>
                ...
                <td><b>Nombre: <%=estudiante.elementAt(0)%></b> <br>
                    ...
                    <p><i><b>Usted no ha formalizado su inscripción, debe entregar la documentación
                            correspondiente en las fechas señaladas. Favor comuníquese al 6683600 opción 2 en el menú.
                            </b> </i>
                </td>
            </tr>
        </table>
            ...
            <tr>
                ...
                <td><b>Nombre: <%=estudiante.elementAt(0)%></b>
                    ...
                    <p><i><b>Usted no ha diligenciado su formulario de solicitud de admisión.
                            <font size="3">Por favor comuníquese al 6683600 opción 2 en el menú. 
                   </font></b> </i>
                </td>
            </tr>
        </table>
    ...
    if (estudiante.elementAt(2).equals("-70")) {%>
        ...
        <table width="707" border="0" cellspacing="0" cellpadding="0" align="center" class="textocom" >
            <tr>
    ...
    if (estudiante.elementAt(2).equals("-80")) {%>
        ...
        <table width="710" border="0" cellspacing="0" cellpadding="0" align="center" class="textocom">
            <tr>
    ...
    if (estudiante.elementAt(2).equals("-65")) {%>
        <table width="710" border="0" cellspacing="0" cellpadding="0"  align="center" class="textocom">
            ...
            pericfes = estudiante.elementAt(5).toString().substring(2, 7);%>
                ...
                out.println("<b>Lenguaje:&nbsp;&nbsp;&nbsp;&nbsp;" + estudiante.elementAt(9) + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + clasifica4 + "</b><br>");
                    ...
                    <p>Lo anterior significa que a m&aacute;s tardar el 26 de junio se le informar&aacute;
        ...
        <p>Cordialmente <br> Dirección de Ciencias Básicas.-->
                    <%//} else {%>
                    <p><i>Para mayor información por favor comuníquese al 6683600 opción 2 en el menú.
                        <br>
                        <br>
