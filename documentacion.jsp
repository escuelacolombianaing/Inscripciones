...
<table align="center" width="740" border="0" cellpadding="0" cellspacing="0" >
    ...
    <form name="fmArchivos" method="post" action="Documentacion?on=ar&spath=correo&nombre=<%=nombre%>&doc=<%=doc%>&ref=<%=ref%>">
     ...
     Date fec = new Date(adjuntar.fecArchivo(i));*/
        ...
        adicional comuníquese al 6683600 opción 2 en el menú. </b></center>
     ...
     out.println("<CENTER><b><br>Usted no está autorizado para realizar este proceso. Para mayor información comuníquese al 6683600 opción 2 en el menú.</b></center>");
