...
//String titulo = "Inscripciones Extemporáneas";
...
<html>
 ...
 <%if (ban == 1) {%>
   ...
   <%} else {%>
           ...
           alert("Solo se habilitará en las fechas programadas, para cualquier información comuníquese con la Oficina de Admisiones, ext.263-274");
   <%}%>
       }
...
<table width="640" border="0" align="center" class="textocom">
  <tr> 
    <td> 
      ...
      <table width="95%" border="0" cellspacing="0" cellpadding="0" class="textocom">
        ...
        <tr> 
          <td colspan="2" bgcolor="#336699" class="bodystyle"  onMouseOver="textoin('f6'); ilum(this,'#ACC8E3')" onMouseOut="textout('f6'); ilum(this,'#336699')"><!--a href="javascript:ventanaSecundaria('ReferenciaPago?tipoest=N')" onMouseOut="window.status='  '"
        ...
        <tr> 
          <td> 
            ...
            <p><b><a href="http://www.escuelaing.edu.co/admisiones/2009/primersemestre.htm"><font color="#336699">[+ 
      ...
      <%  }
        if (tipoest.equals("R")) {%>
      <p class="resaltados"><strong>Seguimiento Académico: </strong></p>
      ...
      <table width="95%" border="0" cellspacing="0" cellpadding="0" class="textocom">
        ...
        <tr> 
          <td colspan="2" bgcolor="#336699"  onMouseOver="textoin('f9'); ilum(this,'#ACC8E3')" onMouseOut="textout('f9'); ilum(this,'#336699')"><a href="javascript:ventanaSecundaria('ReferenciaPago?tipoest=R')" onMouseOut="window.status='  '"
        ...
        <tr> 
          <td> 
            ...
            <p><b class="resaltados"><a href="http://www.escuelaing.edu.co/admisiones/2009/seguimientoacad.htm"><font color="#336699">Más 
              información.</font> </a></b>Requisitos, Procedimientos, Documentos.</p>
          </td>
        </tr>
      </table>
          ...
          <td> 
            <p>Tenga en cuenta que no podr&aacute; diligenciar el formulario despues 
              ...
              <a href="javascript:ventanaSecundaria('SolicitudAdm?tipoest=T')" onMouseOut="window.status='  '"
                                                                                     onMouseOver="window.status='http://www.escuelaing.edu.co';return true"><font color="#336699"><strong>IMPRIMALA 
              AQUI</strong></font><strong>.</strong></a></p>
            <p><b class="resaltados"><a href="http://www.escuelaing.edu.co/admisiones/2009/transferencia.htm"><font color="#336699">Más 
              información. </font></a></b>Requisitos, Procedimientos, Documentos.</p>
          </td>
        </tr>
      </table>
      ...
      <p><b class="resaltados"><a href="http://www.escuelaing.edu.co/admisiones/2009/reintegro.htm"><font color="#336699">Más 
        información</font></a></b> Requisitos, Procedimientos, Documentos.</p>
      <p> 
        <%} if (tipoest.equals("Z")) {%>
      </p>
  ...
  <tr> 
    <td colspan="2" > 
      <p>&nbsp;</p>
      <p><b class="resaltados"><a href="http://www.escuelaing.edu.co/admisiones/2009/readmision.htm"><font color="#336699">Más 
        información</font></a></b> Requisitos, Procedimientos, Documentos.</p>
      <p>&nbsp;</p>
    </td>
  </tr>
