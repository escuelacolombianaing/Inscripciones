...
<html>
        ...
        <table width="710" border="0" cellspacing="0" cellpadding="0" align="center"  class="textoimpremas">
            <tr>
                <td>
                    ...
                    Tel&eacute;fono: 6683600 Ext: 274, 263 o 101</b>
    ...
    if (com5 == 'A') {
        ...
        %>
        <!--&& ban == 0-->
        <%  if ((estudiante.elementAt(2).equals("-60") || estudiante.elementAt(2).equals("60") || estudiante.elementAt(2).equals("3"))) {%>
         ...
         if (niveles.equals(baseicfes)) {
            ...
            <tr>
                <td>
                    ...
                    <p><b>La jornada de inducción</b> se realizará del <%=induccion%>. Allí se le proporcionará
                    ...
                    <p>Actualmente se est&aacute;n realizando los estudios socioecon&oacute;micos
                        ...
                        Para apellidos del aspirante que estén entre las letras <B><%=grupo1%></B>

                        Para los apellidos que estén entre las letras <B> <%=grupo2%></B>

                        Para los apellidos que estén entre las letras <B><%=grupo3%></B>
                        ...
                        instrucciones necesarias para formalizar la misma
                        (documentos requeridos y procedimiento a seguir).
                  ...
                  <!--  El recibo de pago correspondiente a los derechos de matr&iacute;cula y
                    ...
                    y procedimiento a seguir), los puede reclamar el jueves 7 de Enero de
                    2010, de 2:00 p.m a 5 p.m. en la Oficina de Apoyo Financiero, primer piso,
                    Bloque A. Si usted ya reclamó su orden haga caso omiso a este mensaje.-->

                        <%} else if (estudiante.elementAt(1).equals("13")) {%>
                        Por todo lo anterior, los  Directivos de la Institución le invitan a una reuni&oacute;n a usted y a su acudiente
                        el d&iacute;a <%=fecha%>

                        Para apellidos del aspirante que estén <font color="#0000FF">entre las letras  </font> <%=grupo1%>

                        Para los apellidos que estén entre las letras <%=grupo2%>
    ...
    if (estudiante.elementAt(2).equals("-83")) {%>
        <br>
        ...
        <table width="702" border="0" cellspacing="0" cellpadding="0" align="center" class="textoimpremas">
            <tr>
                ...
                <td><b>Nombre: <%=estudiante.elementAt(0)%></b> <br>
                    ...
                    Tel&eacute;fono: 6683600 Ext: 274, 263 o 101</b> </i>
                </td>
            </tr>
        </table>
        <%}
            ...
            <tr>
                ...
                <td><b>Nombre: <%=estudiante.elementAt(0)%></b>
                    ...
                    <p><i><b>Usted no ha diligenciado su formulario de solicitud de admisión.
                            <font size="3">Por favor comuníquese con la Oficina de Admisiones. <br>
                    Tel&eacute;fono: 6683600 Ext: 274, 263 o 101</font></b> </i>
                </td>
            </tr>
        </table>
    ...
    if (estudiante.elementAt(2).equals("-80")) {%>
        ...
        <table width="710" border="0" cellspacing="0" cellpadding="0" align="center" class="textoimpremas">
            ...
            <p>Cordialmente <br> Dirección de Ciencias Básicas.-->
                    ...
                    <p>Para mayor información por favor comuníquese con la
    ...
    if (estudiante.elementAt(2).equals("-65")) {%>
        <table width="710" border="0" cellspacing="0" cellpadding="0"  align="center" class="textoimpremas">
            ...
            <p>Cordialmente <br> Dirección de Ciencias Básicas.-->
                    <%//} else {%>
                    <p><i>Para mayor información por favor comuníquese con la Oficina de Admisiones.
                        <br>
                        <br>
                    Tel&eacute;fono: 6683600 Ext: 274, 263 o 101</i>
                    <%}%>
                </td>
            </tr>
            <tr>
...
<center>No existen información del proceso o aún no se encuentra habilitado.
    Por favor comuníquese con la Oficina de Admisiones.
Tel&eacute;fono: 6683600 Ext: 274, 263 o 101</center>
<%}%>