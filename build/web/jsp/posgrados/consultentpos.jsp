...
<html>
    ...
    <body bgcolor="#FFFFFF" text="#000000">
        ...
        <table  align="center" width="80%" border="0" cellspacing="0" cellpadding="0">
            ...
            <% if (id_prog.equals("267")){ %>
            <tr> 
                <td height="43"><font face="Verdana, Arial, Helvetica, sans-serif"> La citación  a entrevista podrá consultarse el 28 de noviembre después de las 5:00 p.m</font></td>
            </tr>
