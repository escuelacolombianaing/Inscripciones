<%-- 
    Document   : FormuPosgrado
    Created on : 21/07/2016, 03:56:44 PM
    Author     : Lucero
--%>
...
<%
    ...
    if (pginsc.size() > 0) {
        idplan = (pginsc.elementAt(1).toString());
        ...
        if (idplan.equals("331")) {
            prog = "MAESTRÍA EN INGENIERÍA INDUSTRIAL MODALIDAD DE INVESTIGACION";
        }
        ...
        if (idplan.equals("330")) {
            prog = "MAESTRÍA EN  INGENIERIA INDUSTRIAL  MODALIDAD DE PROFUNDIZACION";
        }
                        ...
                        <form  name="form1"  method="post" onSubmit="return comprueba( );" action="grabaEstudiantePos">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-7">
                                    <div>
                                        <p><br>Unicamente aparecerán disponibles los programas de posgrado que a la fecha tengan inscripciones abiertas.<br>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-md-6">
                                                        <div class="form-group espaciado">
                                                            ...
                                                            <input type="text" class="form-control" name="campo20" size="20" maxlength="50">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-md-6">
                                                        <div class="form-group espaciado">
                                                            ...
                                                            <input name="campo14" type="text" class="form-control" id="campo13" size="50" maxlength="35" placeholder="dirección" id="">
                                                        </div>
                                                    </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-md-12">							
                                                    <p><strong>*</strong>(máximo 255 caracteres) Indique las razones por las cuales desea seguir este programa de posgrado, o los factores que lo llevaron a pensar que será de gran utilidad en el desarrollo de su vida profesional y laboral, intereses académicos y profesionales y planes futuros. </p>
                                                </div>

                                                <div class="col-xs-12 col-md-12">
                                                    <div class="form-group">
                                                        <textarea class="form-control"  name="campo64" cols="85" rows="2" wrap="VIRTUAL" onBlur="this.value = convertTildes(this.value);" maxlength="255"></textarea>
                                                    </div>
                                                </div>
                                            </div>		                	
                                        </div>
                                    ...
                                    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-3">
                                                    <div class="form-group espaciado">
                                                        <label for="">Telefono<small class="azul">(número-ext)</small></label>
