...
<SCRIPT LANGUAGE="JavaScript">
    ...
    alert("El número de registro ICFES no corresponde a un periodo del 2019");
    return false;
    }
   ...
   // document.forms.form1.prog.focus();
    ...
    alert("Usted NO cumple con los requisitos para aplicar a GENERACION E. Debe ser graduado en el año 2018.");
    ...
    */
    ...
    alert("Usted NO cumple con el puntaje mínimo para aplicar a GENERACION E,recuerde que el puntaje mínimo es 350");
    ...
    alert("Usted NO cumple con el puntaje mínimo para aplicar a SER PILO PAGA, recuerde que para Pilos Mocoa el puntaje mínimo es 313");
     document.forms.form1.puntaje.style.backgroundColor= '#ffcc00';
    document.forms.form1.puntaje.focus();
    return false;
    }
    ...
    alert("Usted NO cumple con el puntaje mínimo para aplicar a SER PILO PAGA, recuerde que para Pilos Pazcífico el puntaje mínimo es 318");
     document.forms.form1.puntaje.style.backgroundColor= '#ffcc00';
    document.forms.form1.puntaje.focus();
    return false;
    }
    ...
    alert("Usted NO cumple con el puntaje de 350 mínimo para aplicar a Generación E");
    return false;
    }
...
<body bgcolor="#FFFFFF" text="#000000">
    ...
    <jsp:include page="encabezado">
        <jsp:param name="titulo" value="SOLICITUD DE NÚMERO DE REFERENCIA PARA HACER LA INSCRIPCIÓN GENERACION E" />
    </jsp:include>
          ...
          <tr> 
            ...
            <td bgcolor="#F3F3F3" width="50%" height="24"> 
              <select name="convenio" size="1" id="convenio"  class="dato1" >
                ...
                <option value="PP">Pilos Pazcífico</option>
              </select>
            </td>
          </tr>
          <%}%>
