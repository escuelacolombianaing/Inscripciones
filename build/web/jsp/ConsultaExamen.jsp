            ...
            <section>
                <div id="formulario">
                    <table  align="center" width="100%" border="0">
                        ...
                        <%if (!confirmat.equals("No disponible") || !confirfis.equals("No disponible") || !confirqui.equals("No disponible")) {%>
                        <tr>
                      ...
                      <tr>
                       ...
                       <!-- <tr>
                            <td><font face="Times New Roman, Times, serif"><a href="correos?docEst=<!%=docEst%>">3. Conozca su correo</a></font></td>
                        </tr>-->
                    </table>
            </section>
