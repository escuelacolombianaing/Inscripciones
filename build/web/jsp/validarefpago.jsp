        ...
        <div class="container-fluid contenidos">
            <div class="row">
                ...
                <div class="col-md-6">   
                    ...
                    <p><font color="#990033"><blink><b><font size="4">Atenci&oacute;n:</font></b></blink></font>
                    </p>
                    <p >Para diligenciar el formulario de solicitud de admisi&oacute;n
                        a alguno de los programas académicos de la Escuela Colombiana de Ingeniería,
                        por favor registre el número de referencia de pago de sus derechos de
                        inscripción y el n&uacute;mero de documento de identidad registrado.</p>
                    <p >Tenga en cuenta que para diligenciar correctamente el
                    ...
                    <ul>
                        <li><p>Estrato del lugar de residencia, el cual debe obtenerse del recibo de energía.</li>
                        <li><p>Valor de pensi&oacute;n mensual pagada en su colegio, tomada de un
                                recibo de pago del mismo.</li>
                        <li><p>C&oacute;digo ICFES del colegio, tomado del documento de resultado
                                del examen de estado.</li>
                        <li><p>Ingresos familiares, tomados de los certificados de ingresos y retenciones
                                o declaraci&oacute;n de renta tanto del padre como de la madre.<br>
                        </li>
                    </ul>
                    <form action="VerificaAspirante" method="POST" name="formvrp" id="formvrp">  
            ...
            <div class="row">
                <div class="col-xs-12 col-md-11 col-md-offset-3" >
                    <div class="submit">
...
<%
        ...
        correo.enviar("Valida Referencia Pago", e.getMessage());
    }
%>