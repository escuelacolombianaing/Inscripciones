...
<body>
    ...
    <nav>
        ...
        <ul class="nav nav-pills nav-justified">
          ...
          <li role="presentation"><a href="proyectosActivos.html"><span class="glyphicon glyphicon-duplicate"></span> Proyectos activos</a></li>
          <li role="presentation" class="active"><a href="seguimiento.html"><span class="glyphicon glyphicon-eye-open"></span> Seguimiento</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 filaCompleta">
                    <h3>A continuación se presentan sus proyectos <strong>con seguimiento a la fecha:</strong></h3><br>
                    <p>
