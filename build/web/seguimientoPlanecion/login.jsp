        ...
        <div class="container inscripcion">
            <div class="row">
                <div class="col-sm-7 col-md-6 col-md-offset-1">
                    <h1>Plataforma de seguimiento a la planeación</h1>
                </div>
                <div class="col-sm-5 col-md-5">
                    <div class="formulario">
                    <form class="form-horizontal">
                      <div class="form-group">
                        <label for="" class="col-sm-9 col-md-5 control-label">Correo electrónico</label>
                        <div class="col-sm-12 col-md-7">
                          <input type="email" class="form-control" id="" placeholder="Email">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="" class="col-sm-8 col-md-5 control-label">Contraseña</label>
                        <div class="col-sm-12 col-md-7">
